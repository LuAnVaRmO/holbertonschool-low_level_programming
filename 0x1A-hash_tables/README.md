...
julien@ubuntu:~/0x1A. Hash tables$
```
* Tip from [Jennie Chu](https://twitter.com/JennieZChu)*- Cohort 1, San Francisco*: if you want to test for collisions, here are some strings that collide using the djb2 algorithm:
...
![hero_iamge](https://s3.amazonaws.com/intranet-projects-files/holbertonschool-low_level_programming/253/IUp9WRHyCwUEg.gif)
...
* `void shash_table_print(cost shash_table_t *ht);`
...
julien@ubuntu:~/0x1A. Hash tables$ 
```
![hero_image](https://s3.amazonaws.com/intranet-projects-files/holbertonschool-low_level_programming/253/php.png)
